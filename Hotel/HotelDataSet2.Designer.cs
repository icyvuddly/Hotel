...
namespace Hotel {
    ...
    public partial class HotelDataSet2 : global::System.Data.DataSet {
        ...
        public partial class RoomsDataTable : global::System.Data.TypedTableBase<RoomsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RoomsRow AddRoomsRow(int NumberRoom, string Type, string Status, decimal Cost) {
        ...
        public partial class RoomsRow : global::System.Data.DataRow {
            ...
            public int NumberRoom {
                get {
                    return ((int)(this[this.tableRooms.NumberRoomColumn]));
                }
                set {
                    this[this.tableRooms.NumberRoomColumn] = value;
                }
            }
...
namespace Hotel.HotelDataSet2TableAdapters {
    ...
    public partial class RoomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Rooms] WHERE (([Id] = @Original_Id) AND ([NumberRoom] = @Origi" +
                "nal_NumberRoom) AND ([Cost] = @Original_Cost))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Rooms] ([NumberRoom], [Type], [Status], [Cost]) VALUES (@Numbe" +
                "rRoom, @Type, @Status, @Cost);\r\nSELECT Id, NumberRoom, Type, Status, Cost FROM R" +
                "ooms WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Rooms] SET [NumberRoom] = @NumberRoom, [Type] = @Type, [Status] = @Status, [Cost] = @Cost WHERE (([Id] = @Original_Id) AND ([NumberRoom] = @Original_NumberRoom) AND ([Cost] = @Original_Cost));
SELECT Id, NumberRoom, Type, Status, Cost FROM Rooms WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, NumberRoom, Type, Status, Cost FROM dbo.Rooms";
        ...
        public virtual int Fill(HotelDataSet2.RoomsDataTable dataTable) {
        ...
        public virtual HotelDataSet2.RoomsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelDataSet2.RoomsDataTable dataTable = new HotelDataSet2.RoomsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelDataSet2.RoomsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_NumberRoom, decimal Original_Cost) {
        ...
        public virtual int Insert(int NumberRoom, string Type, string Status, decimal Cost) {
        ...
        public virtual int Update(int NumberRoom, string Type, string Status, decimal Cost, int Original_Id, int Original_NumberRoom, decimal Original_Cost, int Id) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_NumberRoom));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int NumberRoom, string Type, string Status, decimal Cost, int Original_Id, int Original_NumberRoom, decimal Original_Cost) {
            return this.Update(NumberRoom, Type, Status, Cost, Original_Id, Original_NumberRoom, Original_Cost, Original_Id);
        }
    }
