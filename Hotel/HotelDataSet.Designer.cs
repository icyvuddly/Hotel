...
namespace Hotel {
    ...
    public partial class HotelDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string SurName, string Name, string Patronymic, int Experience) {
...
namespace Hotel.HotelDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [SurName] = @SurName, [Name] = @Name, [Patronymic] = @Patronymic, [Experience] = @Experience WHERE (([Id] = @Original_Id) AND ([Experience] = @Original_Experience));
SELECT Id, SurName, Name, Patronymic, Experience FROM Employees WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, SurName, Name, Patronymic, Experience FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_Id, int Original_Experience) {
        ...
        public virtual int Update(string SurName, string Name, string Patronymic, int Experience, int Original_Id, int Original_Experience, int Id) {
            if ((SurName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_Experience));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SurName, string Name, string Patronymic, int Experience, int Original_Id, int Original_Experience) {
            return this.Update(SurName, Name, Patronymic, Experience, Original_Id, Original_Experience, Original_Id);
        }
    }
